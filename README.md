...
- [iVlog --- 用视频记录生活](#ivlog------------)
  ...
  - [3. 小组成员](#3-----)
  - [4. 开发环境配置](#4-------)
    - [4.1 Oracle 12c安装配置](#41-oracle-12c----)
      - [4.1.1 .配置安全更新](#411-------)
      - [4.1.2 安装选项](#412-----)
      - [4.1.3 选择系统类](#413------)
      - [4.1.4 选择Oracle主目录用户](#414---oracle-----)
      - [4.1.5 目录选择、版本](#415--------)
      - [4.1.6 先决条件检查](#416-------)
      - [4.1.7 概要信息](#417-----)
      - [4.1.8 安装数据库软件](#418--------)
    - [4.2 ADO.NET Entity Framework模型导入](#42-adonet-entity-framework----)
    - [4.3 ASP.NET MVC项目配置](#43-aspnet-mvc----)
    - [4.4 IIS Services部署](#44-iis-services--)
      - [4.4.1 租用服务器](#441------)
      - [4.4.2 安装与配置](#442------)
      - [4.4.3 项目demo](#443---demo)
      - [4.4.4 发布到IIS](#444----iis)
      - [4.4.5 远程访问](#445-----)
  - [5. 核心功能具体实现](#5---------)
    - [5.1 文件上传](#51-----)
      - [5.1.1 HTML表单](#511-html--)
      - [5.1.2 点击上传文件，调用UploadSubmitClick()函数](#512----------uploadsubmitclick----)
      - [5.1.3 保存视频文件，将视频信息保存到数据库](#513-------------------)
      - [5.1.3 效果展示](#513-----)
        - [上传视频](#----)
        - [上传成功](#----)
        - [保存到文件夹中](#-------)
  ...
  - [6. 功能截屏展示](#6-------)
    - [6.1 Account](#61-account)
      - [6.1.1 Account/Index -> 登陆界面](#611-account-index--------)
      - [6.1.2 Account/Register ->注册界面](#612-account-register-------)
    - [6.2 Main](#62-main)
      - [6.2.1 Main/Index -> 首页](#621-main-index------)
        - [分区](#--)
        - [排行榜](#---)
        - [拖动调整分区顺序](#--------)
      - [6.2.2 Main/Search -> 搜索界面](#622-main-search--------)
      - [6.2.3 Main/Upload -> 投稿界面](#623-main-upload--------)
    - [6.3 Video](#63-video)
      - [6.3.1 Video/Index -> 视频播放界面](#631-video-index----------)
        - [评论](#--)
    - [6.4 User](#64-user)
      - [6.4.1 User/Index -> 个人主页（我的动态）](#641-user-index--------------)
      - [6.4.2 User/Attention -> 个人主页（我的关注）](#642-user-attention--------------)
      - [6.4.3 User/History -> 个人主页（浏览历史）](#643-user-history--------------)
      - [6.4.4 User/Favorite -> 个人主页（我的收藏）](#644-user-favorite--------------)
      - [6.4.5 User/Message -> 个人主页（我的消息）](#645-user-message--------------)
      - [6.5.6 User/Setting -> 个人主页（个人信息设置）](#656-user-setting----------------)
    - [6.5 myError](#65-myerror)
      - [6.5.1 myError/Error403 -> 403错误页面](#651-myerror-error403----403----)
      - [6.5.2 myError/Error404 -> 404错误页面](#652-myerror-error404----404----)
      - [6.5.3 myError/Error500 -> 500错误页面](#653-myerror-error500----500----)
  - [7. 项目结构](#7-----)
